    ...
    return (
        <div className="main">
            ...
            <article className="cartochka_tovara">
                <div>
                    <img src= "images/spisok/хатасода_2.png" alt="" className="img_site" />
                </div>
                <div className="info">
                    <div className = "tovar">
                        <h2 className="h2_name">ГАЗИРОВАННЫЙ НАПИТОК <br /> HATA HATASODA ORIGINAL, 450 МЛ</h2>
